...
<h1>User <c:out value="${username}" escapeXml="false" /> </h1>
<h1>Update the content for blogID ${blog.getBlogId()} </h1>
</div>
	<form action="updateblogs" method="post">
		...
		<p>
			...
			<textarea id="newContent" name="newContent" class="form-control" rows="3" value=""></textarea>		
		</p>
