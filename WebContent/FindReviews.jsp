...
<h1>Creating a new Review</h1>
<p>
		<span id="successMessage" class="bg-success"><b>${messages.success}</b></span>
</p>
</div>
<div class="row">
	<a id="createreview" class="pure-button pure-button-primary" href="createreview" role="button">Create a new Review here!	
	</a>
</div>
<form action="findreviews" method="post">
		<h1>Search for reviews by product ID</h1>
		<p>
...
<div class="row">
 ...
 <h2 class="panel-title col-sm-8 col-md-10 col-md-offset-1">Matching Reviews</h2>
 </div>
     ...
     <tr>
            ...
            <c:forEach items="${reviews}" var="review" >
                <tr>
                    ...
                    <td><c:out value="${review.getElectronicProductDetail().getWeb_scraper_order()}" /></td>
