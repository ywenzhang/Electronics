...
<title>Find Ram Memory by Parameters</title>
</head>
	<style type="text/css">
		.page-header {
 		font-style:italic;
...
<body>
	...
	<form class="pure-form" action="findrammemory" method="post">
		<br>
	<h2 class="sub-header">Filters</h2>
		<p>
			<input class="pure-input-rounded" id="memory_Size" name="memory Size" placeholder="Memory_Size" value="${fn:escapeXml(param.memory_Size)}">
		</p>
		<p>
			<input class="pure-input-rounded" id="DDR" name="DDR" placeholder="DDR" value="${fn:escapeXml(param.DDR)}">
		</p>
		<p>
	...
	<h1 class="page-header">Matching Ram Memory</h1>
