...
<title>Find HardDisks by Parameters</title>
</head>
	<style type="text/css">
		.page-header {
 		font-style:italic;
...
<body>
	...
	<form class="pure-form" action="findharddisk" method="post">
		<br>
	<h2 class="sub-header">Filters</h2>
		...
		<p>
			<input class="pure-input-rounded" id="capacity" name="capacity" placeholder="Capacity" value="${fn:escapeXml(param.capacity)}">
		</p>
		<p>
	...
	<h1 class="page-header">Matching HardDisk</h1>
