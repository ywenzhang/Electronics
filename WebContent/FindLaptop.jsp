...
<title>Home Page</title>
	...
	<form class="pure-form" action="findlaptop" method="post">
		<br>
		<h2 class="sub-header">Filters</h2>
		<p>
			<input class="pure-input-rounded" id="producer" name="producer" placeholder="Producer" value="${fn:escapeXml(param.producer)}">
		</p>
		<p>
			<input class="pure-input-rounded" id="display_size" name="display_size" placeholder="Display Size" value="${fn:escapeXml(param.display_size)}">
		</p>
		<p>
		...
		<p>
			<input class="pure-input-rounded" id="CPU_Model_family" name="CPU_Model_family" placeholder="CPU Model" value="${fn:escapeXml(param.CPU_Model_family)}">
		</p>
		<p>
		...
		<p>
			<input class="pure-input-rounded" id="hard_disk_size" name="hard_disk_size" placeholder="Harddisk Size" value="${fn:escapeXml(param.hard_disk_size)}">
		</p>
		<p>
	...
	<h1 class="page-header">Matching Laptops</h1>
