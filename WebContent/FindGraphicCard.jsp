...
<title>Find GraphicCards by Parameters</title>
</head>
	<style type="text/css">
		.page-header {
 		font-style:italic;
...
<body>
	...
	<form class="pure-form" action="findgraphiccard" method="post">
		<br>
	<h2 class="sub-header">Filters</h2>
		<p>
			<input class="pure-input-rounded" id="size" name="size" placeholder="Size" value="${fn:escapeXml(param.size)}">
		</p>
		<p>
			<input class="pure-input-rounded" id="manufacturer" name="manufacturer" placeholder="Manufacturer" value="${fn:escapeXml(param.manufacturer)}">
		</p>
		<p>
			<input class="pure-input-rounded" id="dDR_GDDR" name="dDR_GDDR" placeholder="DDR GDDR" value="${fn:escapeXml(param.dDR_GDDR)}">
		</p>
		<p>
	...
	<h1 class="page-header">Matching GraphicCard</h1>
