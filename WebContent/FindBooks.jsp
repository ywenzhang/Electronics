...
<form action="findbooks" method="post">
		...
		<p>
			...
			<input id="author" name="author" value="${fn:escapeXml(param.author)}">
		</p>
...
<div class="table-responsize col-sm-4 col-md-8 col-md-offset-1">
     <table class="table table-striped"> 
                <tr>
                    <td>BookDelete</td>
                    <td><a href="deletebooks">Delete An Invalid Book Record</a></td>
                </tr>
     </table>
     </div>
<div class="row">
 ...
 <h2 class="panel-title col-sm-8 col-md-10 col-md-offset-1">Matching Books</h2>
 </div>
...
<div class="table-responsize col-sm-8 col-md-10 col-md-offset-1">
     <table class="table table-striped">            <tr>
            ...
            <c:forEach items="${matchbooks}" var="matchbook" >
                <tr>
                    <td><c:out value="${matchbook.getWeb_scraper_order()}" /></td>
                    <td><c:out value="${matchbook.getTitle()}" /></td>
                    <td><c:out value="${matchbook.getAuthor()}" /></td>
                    <td><c:out value="${matchbook.getRating()}" /></td>
                    <td><c:out value="${matchbook.getNumber_of_Ratings()}" /></td>
                    <td><c:out value="${matchbook.getNumber_of_Reviews()}" /></td>
                </tr>
            </c:forEach>
       </table>
        </div>
