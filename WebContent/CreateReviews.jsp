...
<form action=createreview method="post">
		...
		<p>
			<label for="content">ReviewContent</label>
			<textarea id="content" name="content" class="form-control" rows="3" value=""></textarea>		
		</p>
		<p>
